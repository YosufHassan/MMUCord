...
// ignore: import_of_legacy_library_into_null_safe
import 'package:mmucord/user_interface/widgets/common/header_status.dart';
import 'package:mmucord/user_interface/widgets/message_screen/receiver_message.dart';
import 'package:mmucord/user_interface/widgets/message_screen/sender_message.dart';
...
class MessageThread extends StatefulWidget {
  ...
  MessageThread(this.receiver, this.me, this.messageBloc, this.chatsCubit,
      this.typingNotificationBloc, this.screenRouter,
      {String chatId = ''})
      : this.chatId = chatId;
            ...
            Expanded(
              ...
              builder: (_, state) {
                ...
                return new GestureDetector(
                    onTap: (){
                      this.widget.screenRouter.onPageInset(context,receiver);
                    },
                    child:HeaderStatus(
                  receiver.username,
                  receiver.photoUrl,
